...
public class DashboardItemViewWebTeacher extends ActiveCourseSummaryViewWeb implements DashboardCourseViewTeacher {
	...
	private void setUpCsvFileUpload(DashboardItem course) {
		T.call(this);
	...
	private void displayQueueInfo(DashboardItem course) {
		T.call(this);
	...
	private void installQueueActions(DashboardItem course) {
		T.call(this);
	...
	private void installDeleteQueueListener(DashboardItem course) {
		T.call(this);
	...
	private void adjustOpenCloseLinks(DashboardItem course) {
		T.call(this);
	...
	private void installCloseQueueListener(DashboardItem course) {
		T.call(this);
	...
	private void installerOpenQueueListener(DashboardItem course) {
		T.call(this);
