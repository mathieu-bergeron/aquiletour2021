...
public class DashboardViewModel extends ModelViewSubViewHandler<Dashboard, DashboardView> {

	@Override
	protected void handle(Dashboard model, DashboardView view, ViewLoader subViewLoader) {
		T.call(this);
