...
public class Constants {
	...
	public static final int FREQUENT_TASKS_PERDIOD_MINUTES = 1;                     // Every minute, we check for expired sessions and update queue times
	public static final int SESSION_MAX_IDLE_TIME_MINUTES = 30;
