            ...
            (function (introspection) {
                class IntrospectorJSweet extends ca.ntro.core.introspection.Introspector {
                    ...
                    /*private*/ buildList(jsonValue) {
                        ...
                        let outputList = ([]);
                        for (let index159 = 0; index159 < inputList.length; index159++) {
                            let inputValue = inputList[index159];
                            {
                    ...
                    /*private*/ buildMap(jsonValue) {
                        ...
                        let outputMap = ({});
                        {
                            let array161 = Object.keys(inputMap);
                    ...
                    /*private*/ declaredMethods(owner, jsClass) {
                        ...
                        if (prototype != null) {
                            ...
                            for (let index162 = 0; index162 < prototypeMethods.length; index162++) {
                                let method = prototypeMethods[index162];
                                {
